...
class Produto extends \Produto\Entity\Produto implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Produto\\Entity\\Produto' . "\0" . 'prodcod', '' . "\0" . 'Produto\\Entity\\Produto' . "\0" . 'descricao', '' . "\0" . 'Produto\\Entity\\Produto' . "\0" . 'valor');
        }
    ...
    public function getProdcod()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getProdcod();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProdcod', array());

        return parent::getProdcod();
    }
